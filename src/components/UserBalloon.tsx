export default function UserBalloon({ text, time }: { text: string, time: string }) {
    return (
        <>
            <div className={`grid grid-cols-[auto] ml-4 content-end`}>
                {/* <hr className={`border-1 border-[#b4ddff1c] w-[95%] mx-auto mb-5`} /> */}

                <div className={` flex justify-end`}>
                    <div
                        className={'relative bg-[#B4DDFF] text-md text-black pl-3 pr-5 py-4 rounded-xl rounded-tr-none mr-2 max-w-[72vw] md:max-w-[35vw]'}>
                        {text}
