        ...
        <div className={`relative flex justify-center flex-col py-40 md:py-20 lg:p-50 px-5 md:px-20  min-h-[50vh] w-full`}>
            ...
            >
                ...
                <motion.button
                    ...
                    className={`bg-[#0984E9] text-white p-1 w-45 md:w-75 rounded-md md:rounded-lg cursor-pointer hover:bg-[#0984E9]/50 trasition-colors duration-200 hover:cursor-pointer`}>Ir para o Chat</motion.button>
            </motion.div>
